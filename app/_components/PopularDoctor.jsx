                ...
                { doctorList.length > 0 ? doctorList.map ((doctor, index) => (
                        <div
                            ...
                            <div key={ index + index } className={ 'mt-3 items-baseline flex flex-col gap-1' }>
                                ...
                                <h2 key={ doctor.id + 'name' }
                                    className={ 'font-bold' }>Dr. { doctor.name } { doctor.surname }</h2>
                                <h2 key={ doctor.id + 'location' }
                                    className={ 'text-secondary text-sm font-bold' }>{ doctor.location }</h2>
